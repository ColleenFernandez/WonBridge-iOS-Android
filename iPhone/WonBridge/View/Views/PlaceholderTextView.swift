...
class PlaceholderTextView: UITextView {
    ...
    */
    ...
    func listenForTextChangedNotifications() {
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(textChangedForPlaceholderTextView(_:)), name:UITextViewTextDidChangeNotification , object: self)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(textChangedForPlaceholderTextView(_:)), name:UITextViewTextDidBeginEditingNotification , object: self)
    }
