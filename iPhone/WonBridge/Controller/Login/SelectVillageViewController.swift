//
//  SelectVillageViewController.swift
//  WonBridge
//
...
let FROM_CHANGEVILLAGE = "From_ChangeVillageVC"
let FROM_LOCAITON = "From_LocationVC"

class SelectVillageViewController: BaseViewController {
    
    var from = FROM_LOCAITON
...
extension SelectVillageViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        cell.setContent(provinces[section])
        return cell
    }
    
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("NameCell") as! NameCell
        cell.setContent(cities[indexPath.section][indexPath.row])
        return cell
    }
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        self.selectedProvince = provinces[indexPath.section]
        self.selectedCity = cities[indexPath.section][indexPath.row]
        
        if from == FROM_CHANGEVILLAGE {
            
            self.performSegueWithIdentifier("unwind2ChangeVillage", sender: self)
        } else {
        
            self.performSegueWithIdentifier("unwindVilllage2Location", sender: self)
        }
