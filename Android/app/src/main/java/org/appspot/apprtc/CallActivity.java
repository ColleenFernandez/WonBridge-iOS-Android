...
public class CallActivity extends Activity
  ...
  public static final int MAX_WAITTING_SECS = 60;

  public static final String EXTRA_USERNAME =
          "org.appspot.apprtc.USERNAME";
  ...
  public static final String EXTRA_ISSENDER =
          "org.appspot.apprtc.SENDER";
  public static final String EXTRA_OTHERIDX =
          "org.appspot.apprtc.OTHERIDX";
  ...
  private int _otherIdx = 0;
  private long _callStartedTime = 0;
  private long _duration = 0;
  private boolean _isCallConnected = false;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Commons.g_callActivity = this;

    _isSender = intent.getBooleanExtra(EXTRA_ISSENDER, false);
    _otherIdx = intent.getIntExtra(EXTRA_OTHERIDX, 0);

    _player = MediaPlayer.create(this, R.raw.videocall);
  ...
  protected void onDestroy() {
    ...
    Commons.g_callActivity = null;
  }


  public void onCallNoAnswer() {

    Commons.g_xmppService.sendVideoNoAnswer(_otherIdx);
    disconnect();
  }
  ...
  public void onCallHangUp() {
    ...
    if (_callStartedTime == 0)
      Commons.g_xmppService.sendVideoCancel(_otherIdx);
  ...
  public boolean onToggleCamera() {
    if (peerConnectionClient != null) {
      ...
      peerConnectionClient.setVideoEnabled(cameraEnabled);
    }
...
//        roomConnectionParameters.roomUrl));
  ...
  private void callConnected() {
    ...
    _callStartedTime = System.currentTimeMillis();
  ...
  private void disconnect() {
    ...
    if (_callStartedTime != 0) {
      _duration = System.currentTimeMillis() - _callStartedTime;
      _callStartedTime = 0;

      if (_isSender)
        Commons.g_xmppService.processVideoCallMessage(_otherIdx, Commons.g_user.get_idx(), getString(R.string.call_duration) + Commons.getDurationString((int)_duration));
      else
        Commons.g_xmppService.processVideoCallMessage(_otherIdx, _otherIdx, getString(R.string.call_duration) + Commons.getDurationString((int)_duration));
    }
  ...
  public void onDecline() {
    ...
    Toast.makeText(this, Constants.VIDEO_CHATTING_DECLINE, Toast.LENGTH_SHORT).show();
    disconnect();
