...
public class ChargeOnlineActivity extends CommonActivity implements View.OnClickListener {
    ...
    private void loadLayout() {
        ...
        txvTitle.setText(getString(R.string.charge_online));
    ...
    public void onWechatPay() {
        ...
        if (msgApi.isWXAppSupportAPI()) {
            ...
            ChargeOnlineActivity.GetPrepayIdTask getPrepayId = new ChargeOnlineActivity.GetPrepayIdTask();
            getPrepayId.execute();
        } else {
    ...
    private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String, String>> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(ChargeOnlineActivity.this, getString(R.string.app_tip),
