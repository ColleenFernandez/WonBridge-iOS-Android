...
public class ChangeWorkingActivity extends CommonActivity implements View.OnClickListener {


    EditText ui_edtWorking;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_change_working);
    ...
    private void loadLayout() {
        ...
        txvTitle.setText(getString(R.string.change_working));
        ...
        ui_edtWorking.setText(Commons.g_user.get_working());
        ...
        lytContainer.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                imm.hideSoftInputFromWindow(ui_edtWorking.getWindowToken(), 0);
                return false;
            }
        });
    ...
    public void onChangeWorking() {
        ...
        String working = ui_edtWorking.getText().toString().replace(" ", "%20");
    ...
    public void parseWorkingResponse(String json){
        ...
        try{
            ...
            if(result_code == ReqConst.CODE_SUCCESS){
                Commons.g_user.set_working(ui_edtWorking.getText().toString());
                setResult(RESULT_OK);
                finish();
            }
